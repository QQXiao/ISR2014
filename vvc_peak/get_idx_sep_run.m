function [idx_ERS_I,idx_ERS_IB_all,idx_ERS_IB_wc,idx_ERS_D,idx_ERS_DB_all,idx_ERS_DB_wc,idx_mem_D,idx_mem_DB_all,idx_mem_DB_wc,idx_ln_D,idx_ln_DB_all,idx_ln_DB_wc]=get_idx(s,r)
...
%perpare data
    ...
    all_pID1=[]; all_pID2=[]; all_wID1=[]; all_wID2=[]; all_Rcate=[]; all_mem1=[];  all_mem2=[]; all_phase1=[]; all_phase2=[]; all_cate1=[]; check_run=[]; check_group=[]; check_cate=[];all_run1=[];all_run2=[];
    for k=2:TN
        ...
        all_run1=[all_run1 all_label(k-1,Mrun1)*ones(1,TN-k+1)];
        all_run2=[all_run2 all_label(k:TN,Mrun1)']; 
    ...
    %% get indexes
    idx_ERS_I=find(all_run1==r & all_phase1==1 & all_phase2==2 & all_mem2<=2 & all_pID1==all_pID2 & all_wID1==all_wID2);%identity pair: p+c+
    idx_ERS_IB_all=find(all_run1==r & all_phase1==1 & all_phase2==2 & all_mem2<=2 & all_pID1~=all_pID2 & check_run==1 & check_group==1);
    idx_ERS_IB_wc=find(all_run1==r & all_phase1==1 & all_phase2==2 & all_mem2<=2 & all_pID1~=all_pID2 & check_run==1 & check_group==1 & check_cate==1);
    idx_ERS_D=find(all_run1==r & all_phase1==1 & all_phase2==2 & all_mem2<=2 & all_pID1==all_pID2 & all_wID1~=all_wID2);%%same face different words: p+c-
    idx_ERS_DB_all=find(all_run1==r & all_phase1==1 & all_phase2==2 & all_mem2<=2 & all_pID1~=all_pID2 & check_run==1 & check_group==0);
    idx_ERS_DB_wc=find(all_run1==r & all_phase1==1 & all_phase2==2 & all_mem2<=2 & all_pID1~=all_pID2 & check_run==1 & check_group==0 & check_cate==1);
    %mem
    idx_mem_D=find(all_run1==r & all_phase1==2 & all_phase2==2 & all_mem1<=2 & all_mem2<=2 & all_pID1==all_pID2 & all_wID1~=all_wID2);%%same face different words: p+c-
    idx_mem_DB_all=find(all_run1==r & all_phase1==2 & all_phase2==2 & all_mem1<=2 & all_mem2<=2 & all_pID1~=all_pID2 & check_run==1 & check_group==0);
    idx_mem_DB_wc=find(all_run1==r & all_phase1==2 & all_phase2==2 & all_mem1<=2 & all_mem2<=2 & all_pID1~=all_pID2 & check_run==1 & check_group==0 & check_cate==1);
    %ln
    idx_ln_D=find(all_run1==r & all_phase1==1 & all_phase2==1 & all_pID1==all_pID2 & all_wID1~=all_wID2);%%same face different words: p+c-
    idx_ln_DB_all=find(all_run1==r & all_phase1==1 & all_phase2==1 & all_pID1~=all_pID2 & check_run==1 & check_group==0);
    idx_ln_DB_wc=find(all_run1==r & all_phase1==1 & all_phase2==1 & all_pID1~=all_pID2 & check_run==1 & check_group==0 & check_cate==1);
end %func
